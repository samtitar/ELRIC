"""
Mostly copy-past from DINO repository:
https://github.com/facebookresearch/dino

Added context features to the data loader and modified the data loader to load images from HDF5 files.
"""
...
from src.models import DINOHead

import wandb
import sys
from src.data import CharacterSequenceDataset
...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default=768,
        type=int,
        help="""Dimensionality of the context features.""",
    )
    parser.add_argument(
        "--norm_last_layer",
        default=True,
    ...
    parser.add_argument(
        ...
        default=0.04,
        type=float,
        help="""Initial value for the teession-in-comicacher temperature: 0.04 works well in most cases.
...
def train_dino(args):
    ...
    if utils.is_main_process():
        wandb.init(project="dino-comics")
    ...
    dataset = CharacterSequenceDataset(args.data_path, split="train", character_transform=transform)
...
def train_one_epoch(
    ...
    for it, (images, context_features) in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        teacher.context_features = context_features
        student.context_features = context_features
